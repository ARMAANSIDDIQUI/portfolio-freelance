      ...
      >
        ...
        <div className="space-y-8">
          ...
          <div className="flex gap-6">
             ...
             <a href="https://wa.me/+917017086408" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:border-red-600 hover:bg-red-600 transition-all group">
