...
const AIConsultant: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-[100] font-sans">
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="absolute bottom-20 right-0 w-[350px] md:w-[400px] h-[500px] bg-neutral-900 border border-white/10 rounded-3xl shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-bottom-4 duration-300">
